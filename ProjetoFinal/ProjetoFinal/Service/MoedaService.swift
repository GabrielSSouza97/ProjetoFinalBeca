...
class MoedaService : MoedaServiceProtocol {
    ...
    func getDataFromServer(complete: @escaping (Bool, [Moeda]?) -> ()) {
        ...
        AF.request("https://rest-sandbox.coinapi.io/v1/assets?apikey=50F5E142-F260-4CCE-95F6-713F18D30FC3").validate().responseDecodable(of: [Moeda].self) { apiResponse in
